...
- (void)viewDidLoad {
    ...
    [JMRequestNetWorkCache sharedMethod].isDebug = NO;
}

- (IBAction)requestAction:(id)sender
{
        
        [JMRequestNetWorkCache getWithUrl:url refreshCache:YES success:^(id responseObject) {
            ...
            NSLog(@"cache size is  %@", [JMRequestNetWorkCache fileSizeWithDBPath]);
        } fail:^(NSError *error) {
        ...
        [JMRequestNetWorkCache getWithUrl:url1 refreshCache:YES success:^(id responseObject) {
